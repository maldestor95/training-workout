import {  Serie, Workout, workoutInterface, serieInterface } from '../src/workout';
  ...
  () => {
    describe('serie', () => {
      it('should be properly initialised', () => {
        ...
        expect(JSON.parse(testSerie.stringify())).to.deep.equal({ repetition: 12, weight: 10, level: 5,durationInMinutes:50 ,status:"A FAIRE"});
      })
    ...
    describe('workout',()=>{
      ...
      it('should get the workout status',()=>{
        ...
        // console.log(wk.getWorkoutStatus().serie)
